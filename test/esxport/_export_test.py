...
class TestExport:
    ...
    def test_export_with_valid_arguments(
        ...
        export = create_autospec(EsXport(cli_options, es_client_without_data).export)
    ...
    def test_export_invalid_format(
        ...
        with patch.object(EsXport, "_extract_headers", return_value=[]), pytest.raises(NotImplementedError):
            EsXport(cli_options, es_client_without_data).export()
    ...
    def test_headers_extraction(
        ...
        assert EsXport(cli_options, es_client_without_data)._extract_headers() == keys
